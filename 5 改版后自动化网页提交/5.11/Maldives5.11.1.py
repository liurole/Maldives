...
# STEP 1，读入文档数据
    ...
    #打开文档
    document = Document('./提交/5/测试提交.docx')
    #读取每段资料
...
# STEP 2，读入文档数据 发布文章
    ...
    # 新产品
    if MyContent_type == '选型':
        browser.find_element_by_xpath('//*[@id="root"]/div/div/div[2]/div[1]/div[2]/form/div[3]/div/div/div[2]/div/div/label[5]/span[1]').click()
    elif MyContent_type == '新技术':
        browser.find_element_by_xpath('//*[@id="root"]/div/div/div[2]/div[1]/div[2]/form/div[3]/div/div/div[2]/div/div/label[2]/span[1]').click()    
