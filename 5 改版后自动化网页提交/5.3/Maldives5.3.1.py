...
if __name__ == '__main__':
    ...
    for key, value in opts:
        ...
        if key in ['-i', '--index']:
            index = value
    print('马尔代夫V5.3.1 function with num: ', index ) 
...
# STEP 3，参数的替换
    ...
    if pick['Outer Dimension (mm):'] == '':
        ...
        temp3 = temp3.replace('(W)', 'mm(W)')
        temp3 = temp3.replace('(H)', 'mm(H)')
        temp3 = temp3.replace('(D)', 'mm(D)')
    if pick['Mass (g):'] == '':
        err.append('重量')
    else:
        temp3 = temp3.replace('YYY', pick['Mass (g):'])
    p3 = temp1 + pl3[1] + temp2 + temp3
