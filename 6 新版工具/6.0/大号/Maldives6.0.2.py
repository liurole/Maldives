...
def submit(browser, data, submit_url):
    ...
    browser.find_element_by_xpath('//*[@id="root"]/div/div[2]/div[2]/div[2]/div/div/div/div/div/form/div[1]/div/div/div/div[2]/div/div/label[3]/span[1]/input').click()
    time.sleep(2)
    ...
    for i, val in enumerate(urls):
        if i > 1:
            temp = '//*[@id="root"]/div/div[2]/div[2]/div[2]/div/div/div/div/div/form/div[2]/div[' + str(i + 1) + ']/div/div/div/div/div/button'
    ...
    reason.send_keys('世强官网尚未有雷同文章，所涉及型号均为2010年以后产品，文章大部分内容由自己提炼总结改写')
    
    # 选型类型
    browser.find_element_by_xpath('//*[@id="root"]/div/div[2]/div[2]/div[2]/div/div/div/div/div/form/div[7]/div/div/div/div[2]/div/div/label[5]/span[1]/input').click()
...
if __name__ == '__main__':
    ...
    file = '选型.xlsx'
    results = excel_table_byindex(file, 1)
